...
void distribute_matrix()
{
  ...
  std::stable_sort(ranking_tuple_array,
                   ranking_tuple_array + ranking_transfer.n,
                   [](const ranking_tuple &a, const ranking_tuple &b) { return a.rank < b.rank; });
  ...
  std::stable_sort(ranking_tuple_array,
                   ranking_tuple_array + ranking_transfer.n,
                   [](const ranking_tuple &a, const ranking_tuple &b) { return a.idx < b.idx; });
