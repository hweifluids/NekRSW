...
target_compile_definitions(nekrs-lib PRIVATE NEKRS_BUILDING_LIBRARY)
if (NEKRS_BUILD_FLOAT)
  target_compile_definitions(nekrs-lib-fp32 PRIVATE NEKRS_BUILDING_LIBRARY)
endif()

set_target_properties(nekrs-lib PROPERTIES LINKER_LANGUAGE CXX OUTPUT_NAME nekrs)
if(WIN32)
  set_target_properties(nekrs-lib PROPERTIES IMPORT_LIBRARY_OUTPUT_NAME nekrs_dll)
endif()
...
if (NEKRS_BUILD_FLOAT)
  ...
  if(WIN32)
    set_target_properties(nekrs-lib-fp32 PROPERTIES IMPORT_LIBRARY_OUTPUT_NAME nekrs_fp32_dll)
  endif()
  if(ENABLE_CPPTRACE)
...
if(WIN32)
  set_target_properties(nekrs-bin PROPERTIES ENABLE_EXPORTS OFF)
endif()
if (NEKRS_BUILD_FLOAT)
  ...
  if(WIN32)
    set_target_properties(nekrs-bin-fp32 PROPERTIES ENABLE_EXPORTS OFF)
  endif()
endif()
