...
"# Windows Nek5000 interface builds are handled by windows/build-nek-interface.ps1.
...
")
  ...
  install(DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/3rd_party/nek5000_parRSB/src/
    ...
    PATTERN "*.c"
    PATTERN "*.h")
  install(FILES ${NEK5000_WIN_TEMPLATE_DIR}/makefile.template DESTINATION nek5000)
  return()
endif()
