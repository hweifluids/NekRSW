...
c-----------------------------------------------------------------------
      ...
      etime_s1  = dnekclock_sync()
      etime_s1  = etime_s1 - etime0
      dtmp8     = irankoff
      ...
      etime_s2 = dnekclock_sync()
      etime_s2 = etime_s2 - etime0
      ...
      enddo
      etime_t1 = dnekclock_sync()
      etime_t1 = etime_t1 - etime0
     ...
     &   vl,0,vr,0,key)
      etime_t2 = dnekclock_sync()
      etime_t2 = etime_t2 - etime0
      ...
      enddo
      etime_t3 = dnekclock_sync()
      etime_t3 = etime_t3 - etime0
...
c-----------------------------------------------------------------------
      ...
      etime0 = dnekclock_sync()
      call nek_file_read(re2_h,count_b,lre2off_b,bufr,ierr)
      etime_s3 = dnekclock_sync()
      etime_s3 = etime_s3 - etime0
