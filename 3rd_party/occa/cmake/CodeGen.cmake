...
if(MSVC)
  set(MAX_NUM_KERNEL_ARGS_DEFAULT "120")
else()
...
if(MSVC)
  ...
  if ("${python_version}" VERSION_LESS "3.7.2")
    message(FATAL_ERROR "Python >= 3.7.2 is required to generate MSVC-compatible OCCA kernel macros.")
  endif()
...
elseif (NOT ${MAX_NUM_KERNEL_ARGS} EQUAL ${OCCA_MAX_ARGS})
  execute_process(COMMAND python --version OUTPUT_VARIABLE python_version)
  string(REGEX MATCH "[0-9.]\+" python_version ${python_version})
  if ("${python_version}" VERSION_LESS "3.7.2")
